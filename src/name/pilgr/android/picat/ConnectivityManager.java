...
public class ConnectivityManager {
    ...
    private void setListeners() {
        usbServer.addListener(new Listener() {
            ...
            public void connected(Connection connection) {
                Log.d("New USB connection");
                usbConnection = connection;
            }

            @Override
            public void disconnected(Connection connection) {
                Log.d("Lost USB connection");
                if (usbConnection == connection) usbConnection = null;
            }
        });
        usbServer.addListener(handshakeListener);
    ...
    public void deactivate() {
        ...
        try {
            ...
            Log.d("Catch NPE due Android 2.2 limitation");
        }
        tcpClient.stop();
        udpClient.stop();
    ...
    private void enableUsb() {
        try {
            ...
            //http://code.google.com/p/android/issues/detail?id=9431
            Log.d("USB disable due Android 2.2 limitation");
            isUsbEnabled = false;
        } catch (IOException e) {
            Log.e(e.getMessage());
        }
            ...
            switch (msg.what) {
                ...
                case SERVER_GREETING:
                    ...
                    if (onConnectionChangeListener != null) {
                        onConnectionChangeListener.onConnect(greeting.osName, greeting.osVersion, greeting.userName, greeting.approvedByUser, greeting.piServerVersion, currConnType);
                    }
    ...
    private class HandshakeListener extends Listener {
        ...
        public void received(Connection connection, Object object) {
            ...
            //GREETING message
                ...
                //Stop USB server, if never used
                if (currConnType == ConnType.WIFI) {
                    disableUsb();
                }
    ...
    private class ConnectionThread extends Thread {
        ...
        public void run() {
            ...
            while (!stopping) {
                ...
                /**
                 * May be USB are connected? We should use it at first
                 */
                if (usbConnection != null) {
                    usbConnection.sendTCP(new Handshake().phone_TrustMe(accountName, accountType));
                    Log.d("Connect via USB..");
                    currConnType = ConnType.USB;
                    break;
                }
    ...
    interface OnConnectionChangeListener {
        void onConnect(String osName_, String osVersion_, String userName_, boolean approvedByUser_, int piServerVersion, ConnType currConnType_);
