...
public class ActionBarHelperBase extends ActionBarHelper {
    ...
    private void setupActionBar() {
        ...
        homeItem.setIcon(R.drawable.icon_actionbar);
    ...
    @Override
    public void setRefreshActionIcon(int resource) {
        ImageButton refreshButton = (ImageButton) mActivity.findViewById(R.id.actionbar_compat_item_refresh);
        if (refreshButton != null) {
            refreshButton.setImageResource(resource);
        }
    }
    ...
    private View addActionItemCompatFromMenuItem(final MenuItem item) {
        ...
        // To get ability to find button later. To hide it, for example
        else {
    ...
    @Override
    public void hideActionItem(int menuId, boolean toHide) {
        View actionButton = mActivity.findViewById(menuId);
        if (actionButton != null) {
            actionButton.setVisibility(toHide ? View.GONE : View.VISIBLE);
        }
    }
}
