...
public abstract class ActionBarHelper {
    ...
    /**
     * Sets the new icon for refresh action
     *
     * @param r drawable resource
     */
    public abstract void setRefreshActionIcon(int r);
    ...
    public abstract void hideActionItem(int menuId, boolean toHide);
}
